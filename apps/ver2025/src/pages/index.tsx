      ...
      <div className="container">
        ...
        <p>
          <a
            ...
            href={`https://npmjs.com/package/@svgr-iconkit/core`}
            target="_blank"
            rel="noopener noreferrer"
          >
            <img
              src={`https://img.shields.io/npm/dm/@svgr-iconkit/core?logo=npm&label=@svgr-iconkit/core&style=flat-square`}
              alt="Check on npmjs.com"
            />
          </a>
        </p>
